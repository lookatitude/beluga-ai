...
1. **📚 [Architecture Documentation](../guides/architecture)** - Understand the framework's design
2. **📦 [Package Design Patterns](../guides/package-design-patterns)** - Learn best practices
...
- **Framework Comparison**: [Comparison with LangChain/CrewAI](../reference/framework-comparison)
