...
Generates a response from Claude models. See [OpenAI Provider Guide](./openai#generate) for detailed API documentation - the interface is identical across providers.
...
Streams responses in real-time. See [OpenAI Provider Guide](./openai#streamchat) for detailed API documentation.
...
Binds tools for function calling. See [OpenAI Provider Guide](./openai#bindtools) for detailed API documentation.
