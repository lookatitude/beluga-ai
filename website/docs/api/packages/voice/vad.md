...
- [type VADError](<#VADError>)
  ...
  - [func NewVADErrorWithDetails\(op, code, message string, err error, details map\[string\]interface\{\}\) \*VADError](<#NewVADErrorWithDetails>)
...
## func [AssertVADProviderInterface](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L203>)
...
## type [AdvancedMockVADProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L16-L31>)
...
### func [NewAdvancedMockVADProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L34>)
...
### func \(\*AdvancedMockVADProvider\) [GetCallCount](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L196>)
...
### func \(\*AdvancedMockVADProvider\) [Process](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L89>)
...
### func \(\*AdvancedMockVADProvider\) [ProcessStream](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L138>)
...
<a name="Config"></a>
## type [Config](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L11-L46>)
...
### func [DefaultConfig](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L114>)
...
### func \(\*Config\) [Validate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L108>)
...
## type [ConfigOption](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L49>)
...
### func [WithEnablePreprocessing](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L94>)
...
### func [WithFrameSize](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L66>)
...
### func [WithMaxSilenceDuration](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L87>)
...
### func [WithMinSpeechDuration](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L80>)
...
### func [WithModelPath](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L101>)
...
### func [WithProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L52>)
...
### func [WithSampleRate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L73>)
...
### func [WithThreshold](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/config.go#L59>)
...
<a name="Metrics"></a>
## type [Metrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L37-L43>)
...
<a name="NewMetrics"></a>
### func [NewMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L46>)
...
### func \(\*Metrics\) [IncrementProcessedFrames](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L84>)
...
### func \(\*Metrics\) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L74>)
...
### func \(\*Metrics\) [RecordProcessing](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L59>)
...
## type [MetricsRecorder](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L11-L15>)
...
<a name="MockOption"></a>
## type [MockOption](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L50>)
...
<a name="WithError"></a>
### func [WithError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L67>)
...
### func [WithNetworkDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L82>)
...
### func [WithProcessingDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L75>)
...
### func [WithProviderName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L53>)
...
### func [WithSpeechResults](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/test_utils.go#L60>)
...
## type [NoOpMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L18>)
...
### func [NewNoOpMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L21>)
...
### func \(\*NoOpMetrics\) [IncrementProcessedFrames](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L34>)
...
### func \(\*NoOpMetrics\) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L30>)
...
### func \(\*NoOpMetrics\) [RecordProcessing](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/vad/metrics.go#L26>)
