...
- [type STTError](<#STTError>)
  ...
  - [func NewSTTErrorWithDetails\(op, code, message string, err error, details map\[string\]interface\{\}\) \*STTError](<#NewSTTErrorWithDetails>)
...
## func [AssertSTTProviderInterface](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L249>)
...
## type [AdvancedMockSTTProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L19-L37>)
...
### func [NewAdvancedMockSTTProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L40>)
...
### func \(\*AdvancedMockSTTProvider\) [GetCallCount](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L163>)
...
### func \(\*AdvancedMockSTTProvider\) [StartStreaming](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L132>)
...
### func \(\*AdvancedMockSTTProvider\) [Transcribe](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L96>)
...
<a name="Config"></a>
## type [Config](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L11-L51>)
...
### func [DefaultConfig](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L126>)
...
### func \(\*Config\) [Validate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L120>)
...
## type [ConfigOption](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L54>)
...
<a name="WithAPIKey"></a>
### func [WithAPIKey](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L64>)
...
### func [WithBaseURL](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L71>)
...
### func [WithChannels](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L106>)
...
### func [WithEnableStreaming](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L113>)
...
### func [WithLanguage](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L85>)
...
<a name="WithModel"></a>
### func [WithModel](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L78>)
...
### func [WithProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L57>)
...
### func [WithSampleRate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L99>)
...
### func [WithTimeout](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/config.go#L92>)
...
<a name="Metrics"></a>
## type [Metrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L46-L55>)
...
<a name="NewMetrics"></a>
### func [NewMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L58>)
...
### func \(\*Metrics\) [DecrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L116>)
...
### func \(\*Metrics\) [IncrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L107>)
...
### func \(\*Metrics\) [RecordStreaming](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L97>)
...
### func \(\*Metrics\) [RecordTranscription](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L74>)
...
## type [MetricsRecorder](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L11-L17>)
...
<a name="MockOption"></a>
## type [MockOption](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L57>)
...
<a name="WithError"></a>
### func [WithError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L74>)
...
### func [WithNetworkDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L89>)
...
### func [WithProviderName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L60>)
...
### func [WithStreamingDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L82>)
...
### func [WithTranscriptions](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L67>)
...
## type [MockStreamingSession](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L170-L178>)
...
### func [NewMockStreamingSession](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L181>)
...
### func \(\*MockStreamingSession\) [Close](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L237>)
...
### func \(\*MockStreamingSession\) [ReceiveTranscript](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L232>)
...
### func \(\*MockStreamingSession\) [SendAudio](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/test_utils.go#L221>)
...
## type [NoOpMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L20>)
...
### func [NewNoOpMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L23>)
...
### func \(\*NoOpMetrics\) [DecrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L43>)
...
### func \(\*NoOpMetrics\) [IncrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L40>)
...
### func \(\*NoOpMetrics\) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L32>)
...
### func \(\*NoOpMetrics\) [RecordStreaming](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L36>)
...
### func \(\*NoOpMetrics\) [RecordTranscription](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/voice/stt/metrics.go#L28>)
