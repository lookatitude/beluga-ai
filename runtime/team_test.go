...
// mockAgent is a simple agent mock for testing.
...
func (m *mockAgent) Children() []agent.Agent { return m.children }
...
func newTransformAgent(id string, fn func(string) string) *mockAgent {
	m := newMockAgent(id)
