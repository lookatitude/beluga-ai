...
func NewSpectralProvider(config *noisereduction.Config) (iface.NoiseCancellation, error) {
	if config == nil {
		return nil, noisereduction.NewNoiseCancellationError("NewSpectralProvider", noisereduction.ErrCodeInvalidConfig,
