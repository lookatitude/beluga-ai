...
func NewWebRTCNoiseProvider(config *noisereduction.Config) (iface.NoiseCancellation, error) {
	if config == nil {
		return nil, noisereduction.NewNoiseCancellationError("NewWebRTCNoiseProvider", noisereduction.ErrCodeInvalidConfig,
