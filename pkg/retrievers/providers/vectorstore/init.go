// Package vectorstore provides registration for the vectorstore retriever provider.
...
//
//     import _ "github.com/lookatitude/beluga-ai/pkg/retrievers/providers/vectorstore"
