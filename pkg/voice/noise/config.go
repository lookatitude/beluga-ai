...
type Config struct {
	// Provider specifies the Noise Cancellation provider (e.g., "rnnoise", "webrtc", "spectral")
	Provider string `mapstructure:"provider" yaml:"provider" validate:"required,oneof=rnnoise webrtc spectral"`

	// NoiseReductionLevel specifies the noise reduction level (0.0-1.0, default: 0.5)
	...
	// EnableAdaptiveProcessing enables adaptive noise reduction
