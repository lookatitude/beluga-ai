...
// It is a key component for retrieval-augmented generation (RAG).
type VectorStore interface {
	...
	AddDocuments(ctx context.Context, docs []schema.Document, embedder iface.Embedder) error
	...
	SimilaritySearchByQuery(ctx context.Context, query string, k int, embedder iface.Embedder) ([]schema.Document, []float32, error)
