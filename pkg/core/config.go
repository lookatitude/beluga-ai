...
type Config struct {
	...
	EnableTracing bool `mapstructure:"enable_tracing" yaml:"enable_tracing" env:"CORE_ENABLE_TRACING"`

	// EnableMetrics enables OpenTelemetry metrics for core operations.
	EnableMetrics bool `mapstructure:"enable_metrics" yaml:"enable_metrics" env:"CORE_ENABLE_METRICS"`

	// LogLevel sets the logging level (debug, info, warn, error).
	LogLevel string `mapstructure:"log_level" yaml:"log_level" env:"CORE_LOG_LEVEL" validate:"oneof=debug info warn error"`
}
