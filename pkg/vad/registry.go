...
import (
	...
	"github.com/lookatitude/beluga-ai/pkg/vad/iface"
)

// Global registry for VAD providers.
var (
...
type Registry struct {
	providers map[string]func(*Config) (iface.VADProvider, error)
	mu        sync.RWMutex
}
...
func GetRegistry() *Registry {
	registryOnce.Do(func() {
		globalRegistry = &Registry{
			providers: make(map[string]func(*Config) (iface.VADProvider, error)),
		}
	})
...
func (r *Registry) GetProvider(name string, config *Config) (iface.VADProvider, error) {
	...
	if !exists {
		return nil, NewVADError("GetProvider", ErrCodeUnsupportedProvider,
