// Package calculator provides a tool implementation for basic arithmetic calculations.
package calculator
...
// NewCalculatorTool creates a new CalculatorTool with the given name and description.
func NewCalculatorTool(name, description string) *CalculatorTool {
...
// NewCalculatorToolWithConfig creates a new CalculatorTool from a ToolConfig.
func NewCalculatorToolWithConfig(cfg tools.ToolConfig) (*CalculatorTool, error) {
	return NewCalculatorTool(cfg.Name, cfg.Description), nil
}
...
var _ iface.Tool = (*CalculatorTool)(nil)
