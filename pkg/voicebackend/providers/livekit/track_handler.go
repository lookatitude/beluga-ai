...
import (
	...
	"github.com/lookatitude/beluga-ai/pkg/voiceutils/audio"
)
...
func (th *TrackHandler) HandleTrackEvent(eventType string) error {
	...
	case "disconnected":
		...
		return voicebackend.NewBackendError("HandleTrackEvent", voicebackend.ErrCodeConnectionFailed,
...
func (th *TrackHandler) ConvertAudioFormat(ctx context.Context, audioData []byte, fromFormat, toFormat string) ([]byte, error) {
	...
	if err != nil {
		return nil, voicebackend.NewBackendError("ConvertAudioFormat", voicebackend.ErrCodeInvalidFormat,
	...
	if err != nil {
		return nil, voicebackend.NewBackendError("ConvertAudioFormat", voicebackend.ErrCodeConversionFailed, err)
	}
...
func (th *TrackHandler) BridgeToPipeline(ctx context.Context, audio []byte) error {
	...
	if err != nil {
		return voicebackend.WrapError("BridgeToPipeline", err)
	}
