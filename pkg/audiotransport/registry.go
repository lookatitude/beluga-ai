...
import (
	...
	"github.com/lookatitude/beluga-ai/pkg/audiotransport/iface"
)

// Global registry for Transport providers.
var (
...
type Registry struct {
	providers map[string]func(*Config) (iface.Transport, error)
	mu        sync.RWMutex
}
...
func GetRegistry() *Registry {
	registryOnce.Do(func() {
		globalRegistry = &Registry{
			providers: make(map[string]func(*Config) (iface.Transport, error)),
		}
	})
...
func (r *Registry) GetProvider(name string, config *Config) (iface.Transport, error) {
	...
	if !exists {
		return nil, NewTransportError("GetProvider", ErrCodeUnsupportedProvider,
