...
func NewWebRTCTransport(config *audiotransport.Config) (transportiface.Transport, error) {
	if config == nil {
		return nil, audiotransport.NewTransportError("NewWebRTCTransport", audiotransport.ErrCodeInvalidConfig,
