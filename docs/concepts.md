# Beluga AI v2 — Design Concepts

This document explains the architectural vision, design principles, and key decisions behind Beluga AI v2.
...
- See [packages.md](packages.md) for package layout, interfaces, and how packages work together
- See [architecture.md](architecture.md) for extensibility patterns, how to add providers and tools
