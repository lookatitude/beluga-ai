...
- [`func NewProvider(ctx context.Context, providerName string, config *Config, opts ...ConfigOption) (iface.ChatModel, error)`](<#NewProvider>)
...
- [type MockOption](<#MockOption>)
  ...
  - [`func WithErrorCode(code string) MockOption`](<#WithErrorCode>)
...
- [type Registry](<#Registry>)
  ...
  - [`func (r *Registry) GetLLM(name string, config *Config) (iface.LLM, error)`](<#Registry.GetLLM>)
  - [`func (r *Registry) GetProvider(name string, config *Config) (iface.ChatModel, error)`](<#Registry.GetProvider>)
  - [`func (r *Registry) IsLLMRegistered(name string) bool`](<#Registry.IsLLMRegistered>)
  - [`func (r *Registry) IsRegistered(name string) bool`](<#Registry.IsRegistered>)
  - [`func (r *Registry) ListLLMs() []string`](<#Registry.ListLLMs>)
  - [`func (r *Registry) ListProviders() []string`](<#Registry.ListProviders>)
  - [`func (r *Registry) Register(name string, factory func(*Config) (iface.ChatModel, error))`](<#Registry.Register>)
  - [`func (r *Registry) RegisterLLM(name string, factory func(*Config) (iface.LLM, error))`](<#Registry.RegisterLLM>)
...
## func [AddSpanAttributesMap](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L144>)
...
## func [AssertErrorType](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L702>)
...
## func [AssertHealthCheck](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L676>)
...
## func [AssertStreamingResponse](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L686>)
...
## func [BatchGenerate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L676>)

```go
func BatchGenerate(ctx context.Context, model iface.ChatModel, prompts []string, options ...core.Option) ([]string, error)
```

BatchGenerate is a convenience function for batch text generation. It processes multiple prompts efficiently, handling errors per-prompt and returning all successful results. If any prompt fails, the error is returned but partial results may still be available.
...
- options: Optional core.Option parameters (temperature, max\_tokens, etc.)
...
## func [ConcurrentTestRunner](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L717>)
...
## func [CreateTestMessages](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L654>)
...
## func [EnsureMessages](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L405>)

```go
func EnsureMessages(input any) ([]schema.Message, error)
```

EnsureMessages ensures the input is a slice of schema.Message. It attempts to convert common input types (like a single string or Message) into the required format. This is a convenience function for handling flexible input types in LLM operations.
...
## func [EnsureMessagesFromSchema](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L422>)
...
## func [GenerateText](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L497>)

```go
func GenerateText(ctx context.Context, model iface.ChatModel, prompt string, options ...core.Option) (string, error)
```

GenerateText is a convenience function for generating text with a ChatModel. It handles message conversion, OTEL tracing, and error handling automatically.
...
## func [GenerateTextWithTools](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L555>)
...
GenerateTextWithTools is a convenience function for generating text with tool calling support. It automatically binds tools to the model and handles tool execution if the model requests it.
...
## func [GetSystemAndHumanPromptsFromSchema](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L450>)

```go
func GetSystemAndHumanPromptsFromSchema(messages []schema.Message) (string, string)
```

GetSystemAndHumanPromptsFromSchema extracts the system prompt and concatenates human messages. This is a utility function that might be useful for models that don't support distinct system messages or require a single prompt string. It separates system messages from human messages and concatenates all human messages into a single string.
...
## func [InitMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L40>)

```go
func InitMetrics(meter metric.Meter, tracer trace.Tracer)
```

InitMetrics initializes the global metrics instance for LLM operations. This should be called once during application startup to enable metrics collection. Subsequent calls are ignored due to sync.Once protection.
...
## func [LoggerAttrs](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L173>)
...
## func [NewAnthropicChat](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L892>)

```go
func NewAnthropicChat(opts ...ConfigOption) (iface.ChatModel, error)
```

NewAnthropicChat creates a new Anthropic chat model provider with the given options. This is a convenience function that internally uses the factory pattern. It sets default model to "claude-3-haiku-20240307" if not specified.
...
## func [NewAnthropicLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L972>)
...
## func [NewBedrockLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L1008>)
...
<a name="NewMockLLM"></a>
## func [NewMockLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L1044>)
...
## func [NewOllamaChat](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L953>)
...
## func [NewOllamaLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L1026>)
...
## func [NewOpenAIChat](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L934>)

```go
func NewOpenAIChat(opts ...ConfigOption) (iface.ChatModel, error)
```

NewOpenAIChat creates a new OpenAI chat model provider with the given options. This is a convenience function that internally uses the factory pattern. It sets default model to "gpt-3.5-turbo" if not specified.
...
## func [NewOpenAILLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L990>)
...
## func [NewProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L129>)

```go
func NewProvider(ctx context.Context, providerName string, config *Config, opts ...ConfigOption) (iface.ChatModel, error)
```

NewProvider creates a new LLM provider instance based on the configuration. It uses the global registry to find and instantiate the appropriate provider.

<a name="RecordSpanError"></a>
## func [RecordSpanError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L136>)
...
## func [RunLoadTest](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L753>)
...
<a name="StartSpan"></a>
## func [StartSpan](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L125>)
...
<a name="StreamText"></a>
## func [StreamText](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L619>)
...
StreamText is a convenience function for streaming text generation. It returns a channel that receives message chunks as they are generated, enabling real-time display of responses as they are produced.
...
## func [TestContext](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L649>)
...
## func [TestProviderInterface](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L868>)
...
## func [ValidateModelName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L756>)

```go
func ValidateModelName(provider, modelName string) error
```

ValidateModelName validates that a model name is supported by a provider. This helps catch configuration errors early before making API calls.
...
## func [WithMaxTokensLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L835>)
...
## func [WithStopWordsLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L855>)
...
## func [WithTemperatureLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L840>)
...
## func [WithToolChoiceLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L865>)
...
## func [WithToolsLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L860>)
...
## func [WithTopKLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L850>)
...
## func [WithTopPLegacy](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L845>)
...
## type [AdvancedMockChatModel](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L58-L75>)
...
### func [NewAdvancedMockChatModel](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L78>)
...
### func (*AdvancedMockChatModel) [Batch](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L365>)
...
### func (*AdvancedMockChatModel) [BindTools](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L307>)
...
### func (*AdvancedMockChatModel) [CheckHealth](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L436>)
...
### func (*AdvancedMockChatModel) [Generate](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L199>)
...
### func (*AdvancedMockChatModel) [GetCallCount](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L470>)
...
### func (*AdvancedMockChatModel) [GetModelName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L325>)
...
### func (*AdvancedMockChatModel) [GetProviderName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L330>)
...
### func (*AdvancedMockChatModel) [Invoke](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L335>)
...
### func (*AdvancedMockChatModel) [Reset](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L477>)
...
### func (*AdvancedMockChatModel) [Stream](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L394>)
...
### func (*AdvancedMockChatModel) [StreamChat](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L227>)
...
## type [AdvancedMockLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L488-L494>)
...
### func [NewAdvancedMockLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L496>)
...
### func (*AdvancedMockLLM) [GetModelName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L518>)
...
### func (*AdvancedMockLLM) [GetProviderName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L522>)
...
### func (*AdvancedMockLLM) [Invoke](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L503>)
...
### func [CreateTestConfig](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L664>)
...
### func [DefaultConfig](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L806>)

```go
func DefaultConfig() *Config
```

DefaultConfig returns a default configuration for LLM operations. The returned config has sensible defaults for most use cases: - 30 second timeout - 3 retries with exponential backoff - Streaming enabled - Observability enabled (tracing, metrics, logging)
...
<a name="Factory"></a>
## type [Factory](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L68-L74>)
...
### func [InitializeDefaultFactory](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L1075>)

```go
func InitializeDefaultFactory() *Factory
```

InitializeDefaultFactory creates and returns a factory with all built-in providers registered. Note: Provider factories must be registered explicitly to avoid circular dependencies. This function returns an empty factory that should be populated with provider factories.
...
<a name="NewFactory"></a>
### func [NewFactory](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L90>)

```go
func NewFactory() *Factory
```

NewFactory creates a new LLM factory instance for managing LLM providers. The factory supports registration of both ChatModel and LLM providers, enabling flexible provider management and creation.
...
### func (*Factory) [CreateLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L301>)

```go
func (f *Factory) CreateLLM(providerName string, config *Config) (iface.LLM, error)
```

CreateLLM creates an LLM provider instance using the registered factory function. The LLM must be registered using RegisterLLMFactory before calling this method.
...
### func (*Factory) [CreateProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L263>)

```go
func (f *Factory) CreateProvider(providerName string, config *Config) (iface.ChatModel, error)
```

CreateProvider creates a ChatModel provider instance using the registered factory function. The provider must be registered using RegisterProviderFactory before calling this method.
...
### func (*Factory) [GetLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L185>)

```go
func (f *Factory) GetLLM(name string) (iface.LLM, error)
```

GetLLM returns a registered LLM provider by name. This method is thread-safe and returns an error if the LLM is not found.
...
### func (*Factory) [GetProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L155>)

```go
func (f *Factory) GetProvider(name string) (iface.ChatModel, error)
```

GetProvider returns a registered ChatModel provider by name. This method is thread-safe and returns an error if the provider is not found.
...
### func (*Factory) [ListAvailableProviders](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L332>)

```go
func (f *Factory) ListAvailableProviders() []string
```

ListAvailableProviders returns a list of all available provider factory names. This includes providers registered via RegisterProviderFactory, not direct instances. This method is thread-safe.
...
### func (*Factory) [ListLLMs](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L232>)

```go
func (f *Factory) ListLLMs() []string
```

ListLLMs returns a list of all registered LLM provider names. This method is thread-safe and returns an empty slice if no LLMs are registered.
...
### func (*Factory) [ListProviders](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L209>)

```go
func (f *Factory) ListProviders() []string
```

ListProviders returns a list of all registered ChatModel provider names. This method is thread-safe and returns an empty slice if no providers are registered.
...
### func (*Factory) [RegisterLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L131>)

```go
func (f *Factory) RegisterLLM(name string, llm iface.LLM)
```

RegisterLLM registers an LLM provider instance with the factory. The LLM can be retrieved later using GetLLM. This method is thread-safe.
...
### func (*Factory) [RegisterLLMFactory](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L379>)

```go
func (f *Factory) RegisterLLMFactory(name string, factory func(*Config) (iface.LLM, error))
```

RegisterLLMFactory registers a factory function for creating LLM providers. The factory function will be called when CreateLLM is invoked with the given name. This method is thread-safe.
...
### func (*Factory) [RegisterProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L112>)

```go
func (f *Factory) RegisterProvider(name string, provider iface.ChatModel)
```

RegisterProvider registers a ChatModel provider instance with the factory. The provider can be retrieved later using GetProvider. This method is thread-safe.
...
### func (*Factory) [RegisterProviderFactory](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L358>)

```go
func (f *Factory) RegisterProviderFactory(name string, factory func(*Config) (iface.ChatModel, error))
```

RegisterProviderFactory registers a factory function for creating ChatModel providers. The factory function will be called when CreateProvider is invoked with the given name. This method is thread-safe.
...
## type [LoadTestScenario](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L744-L750>)
...
<a name="Metrics"></a>
## type [Metrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L28-L44>)
...
<a name="GetMetrics"></a>
### func [GetMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/llms.go#L62>)

```go
func GetMetrics() *Metrics
```

GetMetrics returns the global metrics instance for LLM operations. Returns nil if InitMetrics has not been called.
...
<a name="NewMetrics"></a>
### func [NewMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L47>)
...
### func [NoOpMetrics](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L129>)
...
### func (*Metrics) [DecrementActiveRequests](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L230>)
...
### func (*Metrics) [DecrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L248>)
...
### func (*Metrics) [IncrementActiveRequests](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L221>)
...
### func (*Metrics) [IncrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L239>)
...
### func (*Metrics) [RecordBatch](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L193>)
...
### func (*Metrics) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L153>)
...
### func (*Metrics) [RecordRequest](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L136>)
...
### func (*Metrics) [RecordStream](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L207>)
...
### func (*Metrics) [RecordTokenUsage](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L170>)
...
### func (*Metrics) [RecordToolCall](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L184>)
...
## type [MetricsRecorder](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/metrics.go#L14-L25>)
...
## type [MockMetricsRecorder](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L527-L529>)
...
### func [NewMockMetricsRecorder](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L531>)
...
### func (*MockMetricsRecorder) [DecrementActiveRequests](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L584>)
...
### func (*MockMetricsRecorder) [DecrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L598>)
...
### func (*MockMetricsRecorder) [IncrementActiveRequests](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L577>)
...
### func (*MockMetricsRecorder) [IncrementActiveStreams](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L591>)
...
### func (*MockMetricsRecorder) [RecordBatch](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L563>)
...
### func (*MockMetricsRecorder) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L542>)
...
### func (*MockMetricsRecorder) [RecordRequest](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L535>)
...
### func (*MockMetricsRecorder) [RecordStream](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L570>)
...
### func (*MockMetricsRecorder) [RecordTokenUsage](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L549>)
...
### func (*MockMetricsRecorder) [RecordToolCall](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L556>)
...
<a name="MockOption"></a>
## type [MockOption](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L98>)
...
<a name="WithError"></a>
### func [WithError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L115>)
...
### func [WithErrorCode](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L124>)

```go
func WithErrorCode(code string) MockOption
```

WithErrorCode configures the mock to return a specific LLM error code. This is a convenience function for creating common error scenarios.

<a name="WithHealthState"></a>
### func [WithHealthState](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L183>)
...
### func [WithNetworkDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L176>)
...
### func [WithProviderName](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L101>)
...
### func [WithResponses](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L108>)
...
### func [WithStreamingDelay](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L169>)
...
### func [WithToolResults](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L190>)
...
<a name="MockTool"></a>
## type [MockTool](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L807-L812>)
...
### func [NewMockTool](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L814>)
...
### func (*MockTool) [Batch](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L847>)
...
### func (*MockTool) [Definition](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L829>)
...
### func (*MockTool) [Description](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L825>)
...
### func (*MockTool) [Execute](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L837>)
...
### func (*MockTool) [Name](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L821>)
...
### func (*MockTool) [SetResult](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L863>)
...
### func (*MockTool) [SetShouldError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L859>)
...
## type [MockTracingHelper](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L606-L608>)
...
### func [NewMockTracingHelper](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L610>)
...
### func (*MockTracingHelper) [AddSpanAttributes](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L632>)
...
### func (*MockTracingHelper) [EndSpan](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L639>)
...
### func (*MockTracingHelper) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L625>)
...
### func (*MockTracingHelper) [StartOperation](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/test_utils.go#L614>)
...
### func (*OpenTelemetryTracer) [AddSpanAttributes](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L54>)
...
### func (*OpenTelemetryTracer) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L46>)
...
### func (*OpenTelemetryTracer) [StartSpan](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L35>)
...
<a name="Registry"></a>
## type [Registry](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L18-L22>)
...
### func [GetRegistry](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L25>)
...
<a name="Registry.GetLLM"></a>
### func (*Registry) [GetLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L69>)
...
### func (*Registry) [GetProvider](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L50>)
...
<a name="Registry.IsLLMRegistered"></a>
### func (*Registry) [IsLLMRegistered](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L120>)
...
### func (*Registry) [IsRegistered](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L112>)
...
<a name="Registry.ListLLMs"></a>
### func (*Registry) [ListLLMs](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L100>)
...
### func (*Registry) [ListProviders](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L88>)
...
### func (*Registry) [Register](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L36>)
...
<a name="Registry.RegisterLLM"></a>
### func (*Registry) [RegisterLLM](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/registry.go#L43>)
...
## type [TracingHelper](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L83-L85>)
...
### func [NewTracingHelper](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L88>)
...
### func (*TracingHelper) [AddSpanAttributes](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L110>)
...
### func (*TracingHelper) [EndSpan](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L117>)
...
### func (*TracingHelper) [RecordError](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L103>)
...
### func (*TracingHelper) [StartOperation](<https://github.com/lookatitude/beluga-ai/blob/main/pkg/llms/tracing.go#L96>)
